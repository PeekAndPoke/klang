    ...
    val corpus: List<Triple<String, IgnitorDsl, Int>> = listOf(
        ...
        Triple(
            ...
            IgnitorDsl.Bandpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), env = m(4), attackSec = m(5), decaySec = m(6), sustainLevel = m(7), releaseSec = m(8),
                attackCurve = m(9), decayCurve = m(10), releaseCurve = m(11),
            ),
            12,
        ),
        ...
        Triple(
            "Highpass",
            IgnitorDsl.Highpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), passes = m(4), env = m(5), attackSec = m(6), decaySec = m(7),
                sustainLevel = m(8), releaseSec = m(9), attackCurve = m(10), decayCurve = m(11), releaseCurve = m(12),
            ),
            13,
        ),
        ...
        Triple(
            "Lowpass",
            IgnitorDsl.Lowpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), passes = m(4), env = m(5), attackSec = m(6), decaySec = m(7),
                sustainLevel = m(8), releaseSec = m(9), attackCurve = m(10), decayCurve = m(11), releaseCurve = m(12),
            ),
            13,
        ),
