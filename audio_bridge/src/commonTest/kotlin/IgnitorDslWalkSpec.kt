...
class IgnitorDslWalkSpec : StringSpec({
    ...
    val corpus: List<Triple<String, IgnitorDsl, Int>> = listOf(
        ...
        Triple("SuperRamp", IgnitorDsl.SuperRamp(freq = m(0), voices = m(1), spread = m(2), analog = m(3), spreadPower = 7.5, sideAtten = 7.5, gainJitter = 7.5, centerJitterScale = 7.5, phasePool = 7.5, drawTries = 7.5, kMin = 7.5, kMax = 7.5, poolSize = 7.5, refreshEvery = 7.5, selection = "random", warmup = 7.5), 4),
        Triple("SuperSaw", IgnitorDsl.SuperSaw(freq = m(0), voices = m(1), spread = m(2), analog = m(3), spreadPower = 7.5, sideAtten = 7.5, gainJitter = 7.5, centerJitterScale = 7.5, phasePool = 7.5, drawTries = 7.5, kMin = 7.5, kMax = 7.5, poolSize = 7.5, refreshEvery = 7.5, selection = "random", warmup = 7.5), 4),
        Triple("SuperSine", IgnitorDsl.SuperSine(freq = m(0), voices = m(1), spread = m(2), analog = m(3), spreadPower = 7.5, sideAtten = 7.5, gainJitter = 7.5, centerJitterScale = 7.5, phasePool = 7.5, drawTries = 7.5, kMin = 7.5, kMax = 7.5, poolSize = 7.5, refreshEvery = 7.5, selection = "random", warmup = 7.5), 4),
        Triple("SuperSquare", IgnitorDsl.SuperSquare(freq = m(0), voices = m(1), spread = m(2), analog = m(3), spreadPower = 7.5, sideAtten = 7.5, gainJitter = 7.5, centerJitterScale = 7.5, phasePool = 7.5, drawTries = 7.5, kMin = 7.5, kMax = 7.5, poolSize = 7.5, refreshEvery = 7.5, selection = "random", warmup = 7.5), 4),
        Triple("SuperTri", IgnitorDsl.SuperTri(freq = m(0), voices = m(1), spread = m(2), analog = m(3), spreadPower = 7.5, sideAtten = 7.5, gainJitter = 7.5, centerJitterScale = 7.5, phasePool = 7.5, drawTries = 7.5, kMin = 7.5, kMax = 7.5, poolSize = 7.5, refreshEvery = 7.5, selection = "random", warmup = 7.5), 4),
