...
class IgnitorDslWalkSpec : StringSpec({
    ...
    val corpus: List<Triple<String, IgnitorDsl, Int>> = listOf(
        ...
        Triple(
            "Bandpass",
            IgnitorDsl.Bandpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), env = m(4), attackSec = m(5), decaySec = m(6), sustainLevel = m(7), releaseSec = m(8),
                attackCurve = AdsrCurve.Square, decayCurve = AdsrCurve.Cube, releaseCurve = AdsrCurve.SCurve,
            ),
            9,
        ),
        ...
        Triple("Distort", IgnitorDsl.Distort(inner = m(0), amount = m(1), shape = m(2), oversample = m(3)), 4),
        Triple("Div", IgnitorDsl.Div(left = m(0), right = m(1)), 2),
        Triple("Drive", IgnitorDsl.Drive(inner = m(0), amount = m(1)), 2),
        ...
        Triple(
            "Highpass",
            IgnitorDsl.Highpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), env = m(4), attackSec = m(5), decaySec = m(6), sustainLevel = m(7), releaseSec = m(8),
                attackCurve = AdsrCurve.Square, decayCurve = AdsrCurve.Cube, releaseCurve = AdsrCurve.SCurve,
            ),
            9,
        ),
        ...
        Triple(
            "Lowpass",
            IgnitorDsl.Lowpass(inner = m(0), freq = m(1), q = m(2), analog = m(3), env = m(4), attackSec = m(5), decaySec = m(6), sustainLevel = m(7), releaseSec = m(8),
                attackCurve = AdsrCurve.Square, decayCurve = AdsrCurve.Cube, releaseCurve = AdsrCurve.SCurve,
            ),
            9,
        ),
        ...
        Triple(
            "Notch",
            IgnitorDsl.Notch(inner = m(0), freq = m(1), q = m(2), analog = m(3), env = m(4), attackSec = m(5), decaySec = m(6), sustainLevel = m(7), releaseSec = m(8),
                attackCurve = AdsrCurve.Square, decayCurve = AdsrCurve.Cube, releaseCurve = AdsrCurve.SCurve,
            ),
            9,
        ),
        ...
        Triple("Phaser", IgnitorDsl.Phaser(inner = m(0), rate = m(1), wet = m(2), center = m(3), sweep = m(4), floor = m(5)), 6),
        ...
        Triple("Tremolo", IgnitorDsl.Tremolo(inner = m(0), rate = m(1), depth = m(2), shape = m(3), skew = m(4), phase = m(5)), 6),
