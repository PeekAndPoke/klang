...
sealed interface ExciterDsl {
    ...
    @SerialName("sine")
    data class Sine(
        val freq: ExciterDsl = Param("freq", 0.0, "Oscillator frequency in Hz. 0 = use voice frequency."),
    ...
    @SerialName("supersaw")
    data class SuperSaw(
        val freq: ExciterDsl = Param("freq", 0.0, "Base frequency in Hz. 0 = use voice frequency."),
