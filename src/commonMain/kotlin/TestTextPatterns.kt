...
stack( // Gitarre! ----------------------------------------------------------------------------
  ...
  n(`<   [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [ 0 0 0 7] [0  5 0 8] [0 7 0 5] [ 0 7 0 0]
         [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [12 0 0 0 0] [0 10 0 7] [0 8 7 8] [10 8 7@2]>`)
  ...
  n(`<   [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [ 0 0 0 7] [0  5 0 8] [0 7 0 5] [ 0 7 0 0]
    ...
    .s("supersaw").unison(6).detune(0.02).gain(0.25).distort(saw.range(0.5, 1.0).slow(32)).postgain(0.5) // .solo()
  ...
  cat(n(`<[0,7,12]                                [[0,7,12]!3 ~               ~!12]
    ...
    .s("supersaw").unison(6).detune(0.08).gain("0.6 0.5!4 0.55 0.5!2").distort(saw.range(3.5, /*  ---->  */ 11.0 /*  <----  */ ).slow(32)).postgain(0.19)
    .superimpose(x => x.pan(0.65).bandf("800 1050 950 1200|1200|1225|1250".slow(64)).bandq(saw.range(1.0, 5.0).slow(64)).postgain(0.15))    
    .adsr("0.01:0.1:0.5:0.01").clip(1.00).filterWhen(t => t % 64 >= 4).transpose(tp) // .solo()
  , // Noise --------------------------------------------------------------------------------------------------------------
  s("cp cp cp cp").bandf("1800 600 1200 600").gain(0.2) // .solo()
  ...
  ).adsr("0.01:0.3:0.2:1.0").gain(0.65).hpf(60).filterWhen(t => t % 64 >= 4) // .solo()
  , // Drums 1 -----------------------------------------------------------------------------------------------
...
).room(0.02).rsize(3.0) .compressor("-6:1.2:8:0.03:0.2") /*
