...
stack(
  ...
  n(`<[0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [ 0 0 0 7] [0  5 0 8] [0 7 0 5] [ 0 7 0 0]
    ...
    .s("supersaw").unison(8).detune(0.05).distort(saw.range(1.2, 2.2).slow(32)).gain(0.135) //.solo()
  ...
  ).adsr("0.01:0.3:1.0:1.0").gain(0.90) //.solo()
  , // Drums 1 -----------------------------------------------------------------------------------------------
  s("cr hh hh hh hh hh hh hh").fast(2).adsr("0.01:0.3:1.0:1.0") //.solo()
