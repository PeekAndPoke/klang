        ...
        stack(
          ...
          // .hush()
            ...
            >`)
              ...
              .adsr("0.01:0.5:0.5:0.8")
              .superimpose(x => x.transpose("<0 12 0 -12>/8"))
              .superimpose(x => x.bandf(sine.range(400, 10000).slow(16)).late(0.3).gain(0.3))
            ,
            sound(`<
                    ...
                    [[bd, cr] hh sd oh]         [cr hh cr hh]   [[oh, sd] ht sd [lt, hh]] [sd [ht, hh] [bd bd] [bd bd, hh]]
            >`)
