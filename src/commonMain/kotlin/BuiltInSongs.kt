...
stack(                                                                                                    //////////////          //////////////
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!8]!14 [x!12]!2 [x!8]!32>").fast(2).velocity("1.02 0.95!3 0.98 0.95!3".fast(2))
    .scale("d#2:minor").sound("saw").warmth(saw.range(0.3, 0.1).slow(5*32))
    .notchf(snd).notchq(0.5).lpf("1000").hpf(120).distort("0.2.75:soft:4")
    .adsr("0.01:0.2:0.5:0.05").clip(0.75)  // . solo()
    .gain(0.4).orbit(2).pan(0.725),
  // Drums
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd sd bd sd]!24 [bd [bd,sd] bd [bd,sd]]!8>")
    .orbit(3).gain(0.8).crush(6).crushos(2).hpf(90).lpf("2400:1").lpe("<2!128 2.3!128 2.7!128>").adsr("0.01:0:1.0:0.1"),
