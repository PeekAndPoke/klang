...
stack(                                                                                                                 //        //
  ...
  n("<[0 0 2 4 0 0 -2 -1]!4 [0 [2 4] 0 [2 [2 -1@3]]]!2 [0 [6 4] 0 <[2 3] [-2 -0]>] [4 [2 1] 0 [-2 <-1 -4>]]>/4")
    ...
    .notchf("550:0.5:0").lpf("<1900!48 2400!16>").hpf(180).warmth(saw.range(0.3, 0.1).slow(5*32)).distort("0.3:gentle:4")
    .adsr("0.01:0.25:0.5:0.045").clip(0.75).crush(saw.range(8, 4).slow(32)) //   . solo()
    .gain(0.31).orbit(1).pan(0.2),
  // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!8]!14 [x!12]!2 [x!8]!32>").fast(2).velocity("1.02 0.95!3 0.98 0.95!3".fast(2))
    .scale("d#2:minor").sound("saw")
    .notchf("550:0.5:0").lpf("1300").hpf(140).distort("0.3:soft:4").warmth(saw.range(0.5, 0.1).slow(5*32))
    .adsr("0.01:0.2:0.5:0.05").clip(0.75)  // . solo()
    .gain(0.35).orbit(2).pan(0.8),
  // Drums
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd sd bd sd]!24 [bd [bd,sd] bd [bd,sd]]!8>")
    .orbit(3).gain(0.8).crush(6).crushos(2).hpf(100).lpf("3200:1:2").adsr("0.01:0:1.0:0.1"),
