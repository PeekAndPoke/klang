...
stack(
  ...
  .fast(4).scale("e2:chromatic").clip(0.99).hpf(60).lpf(3000).pan(0.5).adsr("0.00:0.1:0.5:0.05")
  .s("supersaw").unison(6).detune(0.025).gain(1.0).distort(5).postgain(0.15).warmth(0.5)
  .superimpose(
    x => x.bandf(120).bandq(1.5).crush(6).sound("pulse").adsr("0.02:0.05:0.25:0.0"),
    x => x.bandf(1920).bandq(1.25).crush(6).sound("pulse").adsr("0.01:0.05:0.25:0.0"),
    x => x.bandf(2880).bandq(1).crush(8).sound("pulse").adsr("0.00:0.2:0.25:0.0"),
  ) // .solo()
  ...
  // Drums 1 
  , s("<hh!8!8 [oh hh!5 cr hh]!2!8>").n(2).adsr("0.00:0.1:0.5:0.1").hpf(200).postgain(1.15) // .solo()
  // Drums 2
  , s(`<[[bd sd]!2]!4 [bd [bd,sd] bd [bd,sd]]!3 [bd bd [bd,sd] bd  bd bd [bd!2,sd] [bd!2]]!1
        [[bd sd]!16]!8>`).n("<7!8 0!8>").adsr("<0.00:0.3:0.5:0.5!8 0.00:0.2:0.2:0.1!8>").gain(0.9).hpf(40)  // . solo()
)
  .room(0.025).rsize(5)
            """.trimIndent(),
            icon = "guitar",
