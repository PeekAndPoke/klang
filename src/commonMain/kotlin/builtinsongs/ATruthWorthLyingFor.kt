...
stack( // Gitarre! ----------------------------------------------------------------------------
  ...
  n(`<   [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [ 0 0 0 7] [0  5 0 8] [0 7 0 5] [ 0 7 0 0]
    ...
    .orbit(1).fast(4).scale("C3:chromatic").lpf(2500).lpe(1.0).lpq(0.7).clip(0.98) // .solo()
    .s(guitar).oscp("drive", drive * 0.9).oscp("brightness", 6500).oscp("spread", 0.04).hpf(1000).postgain(0.27)
    .transpose(tp).pan(0.4).superimpose(pan(0.6)).velocity("<[1.0 0.95 0.975 0.95]>").filterWhen(t => t % stay > 16)
  , // Melody 2 --------------------------------------------------------------------------------------------------
  n(`<   [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [       0 0 0 7] [0  5       0  8] [0 7 0 5] [ 0 7 0 0]
         [0 0 0 7] [0 5 0 2] [0 3 0 5] [0 3 0 0]  [12|12|15 0 0 0] [0 10|10/15 0 10] [0 8 7 8] [10 8 7@2]>`)
    .orbit(2).fast(4).scale("C4:chromatic").lpf(2300).lpe(1.1).lpq(1.0).clip(0.98).late(0.001)  // . solo()
    .s(guitar).oscp("drive", drive * 0.9).oscp("brightness", 6500).oscp("spread", 0.05).hpf(1200).postgain(0.25)
  ...
  cat(n(`<[0,7,12]                                [[0,7,12]!3 ~                ~!12]
      ...
      n(`<[0 0 0 0 0 0 0 2 0 0 0 8 8 8 8 7]       [0!9 8 8 5 5 5 5 3]
          [0!11 5 8 8 [8,15] [7,14]]              [[[8,15]!4 [8,15]!3 [10,17]] [10,5|10|10|17|17|17|17|22|29]*8]>`).repeat(2),
  ).orbit(3).fast(1).scale("C2:chromatic").clip(0.9935).hpf(180).hpq(1.0).lpf(2500).lpe(1).lpq(1.0).postgain(0.20)
