...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                          //          DISCO!          //
    .orbit(0).scale("<e4:minor!48 e5:minor!16 e4:minor!48 e3:minor!16>").sound("superramp").unison(5).detune(0.08)           //       FOREVER!       //
    .hpf(1550).lpf(1600).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.3).lpadsr("0.007:1.3:0.0:0.01")                              //                  //
    .gain(0.50).distort("0.570:tube:4").postgain("<0.230!48 0.120!16 0.230!48 0.340!16>") // . solo()                           //       //      //
  ...
  n(`<[7 [4@4 2 -1] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.78 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.030").lpadsr("0.005:1.1:0.0:0.015")    
    .hpf("<550!16 360!16 550!16 800!16>").lpf("2800".add(saw.range(1, 0).pow(1.8).mul(800)).slow(4)).lpe(0.8).lpq(1.8)
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.85)).superimpose(hpf(4000).lpf(6000).postgain(0.04))
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .sound("supersaw").unison(7).detune(0.09).gain(0.75).postgain(0.11).distort("1:tube:4").distort(0.85)
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.78 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.028").lpadsr("0.005:1.0:0.0:0.01")    
    .hpf(120).lpf(2400).lpe(0.8).lpq(1.6)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.11).hpf(180).hpf(2450).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-3 [-5 -3@3]] 4!7 [2 [3 4@3]]!1 4!7 [-5 [2 4@3]]>")
           .pan(0.2).superimpose(pan(0.8))
    ).superimpose(hpf(3500).lpf(5500).postgain(0.03)).mute("<0!128 1!16 0!16>").pipeline("pedal").body("wood").bodyMix(0.30)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.1:soft:2").postgain(0.22).clip(0.6)
    .adsr("0.004:5.0:0.0:0.015").lpadsr("0.004:0.2:0.0:0.01").hpf(70).hpq(1.25).lpf(200).lpe(15).lpq(1.0)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.24).hpf(45).lpf(7500).adsr("0.002:0.10:0.5:0.2"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.475).late(0.002).orbit(5).gain(0.30).hpf(350).lpf(11500).adsr("0.002:0.10:0.2:0.2")
    .superimpose(x => x.bandf("205".add(berlin.mul(10))).bandq(4).vel(0.70).hpf(190).lpf(350)),
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.525).late(0.0005).orbit(5).gain(0.34).hpf(800).lpf("11500".add(perlin.mul(300))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("pink!8").orbit(6).gain(0.08).hpf(10000).pan(sine.range(0.25, 0.75).slow(3)).adsr("0.008:0.3:0.0:0.01") //  .solo(),
  // Master
