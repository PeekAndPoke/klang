...
stack(                                                                                                                  
  ...
  sound("<pink ~ pink pink>*16").orbit(7).gain(0.04).hpf(4000).lpf(perlin.range(15000, 16000)).lpq(0.5)
    .pan(sine.range(0.4, 0.6).slow(11)).adsr("0.005:0.15:0.0:0.05") //  .solo()
  // Master
  ,master(Master.of(MasterFx.reverb().wet(0.04).damp(0.7).roomSize(7), MasterFx.gain(1.65)))
