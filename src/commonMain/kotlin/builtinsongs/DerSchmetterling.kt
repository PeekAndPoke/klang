...
stack(    
  stack(
    ...
    n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-4 -1 [4 3]|[5 3]|3|3|3 [1 -1]|1|1|1|1]>*2`)
      .orbit(0).scale("<e4:minor!48 e5:minor!16 e4:minor!48 e3:minor!16>")
      .gain(0.40).postgain("<0.110!48 0.055!16 0.110!48 0.140!16>")  // . solo()                  
      .sound(guitar).unison(17).spread(0.20).oscp("presenceHz", 3500).oscp("presenceQ", 2.6).oscp("presence", 4.5).oscp("hptrack", 1.0)    
      ...
      .mute("<1!64 0!32 1!32 0!16>").room("0.3:5:0.1").body("steel").bodyMix(0.4).late(berlin.range(0.0005, 0.003).mul(drunk))
    , // Guitars       
    stack(
      // Guitar 1
      n(`<[0 [0@4 [4 7] -3] -1 <4 3 1> [0 2 4 3] 0 2 <[-1 1 3@2] [[3 4] 6@2 7] [[1 3] 4 3 2] [[6 10 7 5]]>]!4
        ...
        .sound(guitar).unison(15).spread(0.08).oscp("hptrack", 1.00).oscp("hpq", 0.7)  
      ...
      n(`<[11 11 9 8  7 7 9 6] [11 11 [13 11] 8   7  7 5  6] [11 11 9 11  7 7 7 8] [11 11 [13  9] 4      7 4         2         3]
        ...
        .gain(0.5).postgain(0.115).velocity(dynamics.fast(2)) // . solo()
        .sound(guitar).unison(13).spread(0.09).oscp("hptrack", 1.00).oscp("hpq", 1.1)
      ...
      n(`<[0 0 2 4 0 0 -2 -1]!4
        ...
        .sound(guitar).unison(11).spread(0.10).oscp("hptrack", 1.00).oscp("hpq", 1.4)
    ...
    n(`<[0 0 2 4 0 0 -2 -1]!4
      ...
      .struct("<[x!2]!16 [x!2 [x x] x]!16 [[x x] x!3]!32>").fast(2)
  ...
  stack(  
    sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").n(0).mute("<0!128 1!32>")  // . solo()
      .orbit(5).velocity("0.98 0.96 0.97 0.96").pan(0.5).gain(0.205).hpf(30).hpq(1).lpf(8000).adsr("0.001:0.05:0.95:0.2").distort(0.1)
    ...
    sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").n(5).mute("<0!128 1!32>") // . solo()
      .orbit(5).pan(0.5).late(berlin.range(0.0010, 0.0020).mul(drunk)).pan(0.50).gain(0.25).hpf(80).lpf(15000).lpq(0.5).adsr("0.001:0.05:0.95:0.2")
    ...
    sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
      .pan(0.50).late(berlin.range(0.0020, 0.0030).mul(drunk)).orbit(7).gain(0.26).hpf(700).lpf("14000".add(perlin.mul(250).fast(4))).lpq(0.5).adsr("0.003:0.05:0.95:0.5"), // . mute()
