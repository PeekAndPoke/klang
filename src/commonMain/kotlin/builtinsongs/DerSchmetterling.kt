...
stack(                                                                                                                       //////////////          //////////////.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                                //          DISCO!          //.
    ...
    .gain(0.60).distort("0.475:tube:4").postgain("<0.200!48 0.100!16 0.200!48 0.300!16>") // . solo()                                 //       //      //.
  ...
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 0@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.80)).superimpose(hpf(3300).lpf(6000).lpq(1.0).postgain(0.02))
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .hpf(105).lpf(2100).lpe(1.0).lpq(1.3)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.115).hpf(240).lpf(3150).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-7 -3] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
           .pan(0.2).superimpose(pan(0.8))
    ).superimpose(hpf(3150).lpf(5200).lpq(1.0).postgain(0.02)).mute("<0!128 1!16 0!16>").pipeline("pedal").body("rosewood").bodyMix(0.2)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.94 0.96 0.94".fast(2))  // . mute()
    .orbit(3).scale("e1:minor").sound("saw").gain(0.5).distort("0.20:soft:4").postgain(0.20).clip(0.65)
    .adsr("0.015:4.0:0.0:0.015").lpadsr("0.007:0.075:0.0:0.01").hpf(50).lpf(200).lpe(25).lpq(0.8)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.25).hpf(45).lpf(11500).adsr("0.002:0.12:0.5:0.2"),
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.515).late(0.0005).orbit(5).gain(0.33).hpf(800).lpf("11500".add(perlin.mul(300).fast(4))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  ...
  // Master
  ,master(Master.of(MasterFx.reverb().wet(0.015).damp(0.9).roomSize(5), MasterFx.gain(2.8), MasterFx.limiter()))
).analog(feel).seed(timeOfDay.mul(60*60*24))
