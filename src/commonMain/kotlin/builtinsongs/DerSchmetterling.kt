...
stack(                                                                                                                                     //        //.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                               //                              //.
    ...
    .hpf(1800).lpf(1700).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.5).lpadsr("0.007:1.5:0.0:0.02")                                   //       FOREVER!       //.
    .gain(0.60).distort("0.485:tube:4").postgain("<0.200!48 0.085!16 0.200!48 0.290!16>") // . solo()                                 //                  //.
  ...
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 0@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4                                
    ...
    .hpf("<550!16 450!16 550!16 650!16>").lpf("3200".add(saw.range(1, 0).pow(3.0).mul(250)).slow(8)).lpe(1.0).lpq(1.3)
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.80)).superimpose(hpf(3300).lpf(6000).lpq(1.0).postgain(0.10))
    .pipeline("pedal").body("violin").bodyMix(0.5)
  , // Guitar 2
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.007:3.5:0.0:0.032").lpadsr("0.007:1.2:0.0:0.01")    
    ...
    ).superimpose(hpf(3150).lpf(5200).lpq(0.5).postgain(0.03)).mute("<0!128 1!16 0!16>").pipeline("pedal").body("oak").bodyMix(0.5)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.94 0.96 0.94".fast(2))  // . mute()
    ...
    .adsr("0.015:3.0:0.0:0.015").lpadsr("0.005:0.05:0.0:0.01").hpf(50).lpf(160).lpe(30).lpq(0.7)  //  .solo()
  ...
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>") // . solo()
    .pan(0.475).late(0.0015).orbit(5).gain(0.32).hpf(350).lpf(11500).adsr("0.002:0.20:0.2:0.2")
  ...
  ,master(Master.of(MasterFx.reverb().wet(0.05).damp(0.8).roomSize(8),
                    MasterFx.gain(1.5), MasterFx.limiter(),
                    MasterFx.gain(1.8), MasterFx.limiter()))
