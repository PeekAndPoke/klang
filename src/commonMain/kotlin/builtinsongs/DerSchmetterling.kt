...
import * from "sprudel"                                                                                                                       ////.
                                                                                                                                             //  //.
let feel = 15.0    // 0.0 .. ice | 100.0 .. fire                                                                                            //    //.
                                                                                                                                           //      //.
                                                                                                                                          //        //.
stack(                                                                                                                       //////////////          //////////////.
  // Lead                                                                                                                      //                              //.
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                                //          DISCO!          //.
    ...
    .hpf(1700).lpf(1550).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.0).lpadsr("0.007:1.5:0.0:0.01")                                    //                  //.
    .gain(0.50).distort("0.680:tube:8").postgain("<0.200!48 0.100!16 0.200!48 0.300!16>") // . solo()                                 //       //      //.
  ...
  , // Guitar 1
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[6 4] 3@3]>]!4
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .coarse(2).coarseos(8).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.10).hpf(320).lpf(3050).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-7 -3] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.515).late(0.0005).orbit(5).gain(0.32).hpf(800).lpf("11000".add(perlin.mul(500).fast(4))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("brown!8").orbit(6).coarse(sine.range(8, 64).slow(16)).gain(0.50).hpf(4000).lpf(13500)
    .pan(sine.range(0.4, 0.6).slow(11)).adsr("0.005:0.2:0.4:0.02")  // .solo(),
  // Master
).analog(feel).room("0.2:8:0.1").seed(timeOfDay.mul(60*60*24))
