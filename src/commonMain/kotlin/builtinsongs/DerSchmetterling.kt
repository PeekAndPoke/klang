...
stack(                                                                                                                       //////////////          //////////////.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                                //          DISCO!          //.
    ...
    .hpf(1500).lpf(1500).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.8).lpadsr("0.007:1.5:0.1:0.01")                                    //                  //.
    .gain(0.40).distort("0.570:tube:4").postgain("<0.200!48 0.100!16 0.200!48 0.300!16>") // . solo()                                 //       //      //.
  ...
  , // Guitar 1
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .hpf("<550!16 450!16 550!16 700!16>").lpf("3100".add(saw.range(1, 0).pow(1.6).mul(500)).slow(8)).lpe(1.0).lpq(1.4)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.005:2.7:0.0:0.028").lpadsr("0.005:0.7:0.0:0.01")    
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.94 0.96 0.94".fast(2))  // . mute()
    .orbit(3).scale("e1:minor").sound("saw").gain(0.5).distort("0.20:soft:2").postgain(0.20).clip(0.65)
    .adsr("0.007:4.0:0.0:0.015").lpadsr("0.007:0.075:0.0:0.01").hpf(65).lpf(200).lpe(25).lpq(0.8)  //  .solo()
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.515).late(0.0005).orbit(5).gain(0.32).hpf(800).lpf("9000".add(perlin.mul(300).fast(4))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("brown!8").orbit(6).coarse(sine.range(8, 64).slow(16)).gain(0.45).hpf(4000)
