...
stack(                                                                                                                       //////////////          //////////////.
  ...
  n(`<[7 [4@4 2 -1] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .hpf("<550!16 360!16 550!16 800!16>").lpf("3000".add(saw.range(1, 0).pow(1.8).mul(800)).slow(4)).lpe(0.8).lpq(1.9)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .hpf(120).lpf(2550).lpe(0.8).lpq(1.8)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.05:soft:2").postgain(0.18).clip(0.65)
    .adsr("0.007:5.0:0.0:0.015").lpadsr("0.001:0.05:0.0:0.01").hpf(60).hpq(1.0).lpf(200).lpe(25).lpq(1.0)  //  .solo()
  ...
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.485).late(0.002).orbit(5).gain(0.32).hpf(350).lpf(11500).adsr("0.002:0.10:0.2:0.2")
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.515).late(0.0005).orbit(5).gain(0.32).hpf(800).lpf("11500".add(perlin.mul(300))).adsr("0.005:0.15:0.8:0.2"), // . mute()
