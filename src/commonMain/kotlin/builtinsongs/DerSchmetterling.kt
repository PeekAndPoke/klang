...
import * from "sprudel"                                                                                                                       ////.
                                                                                                                                             //  //.
let feel = 10.0    // 0.0 .. ice | 100.0 .. fire                                                                                            //    //.
                                                                                                                                           //      //.
                                                                                                                                          //        //.
stack(                                                                                                                       //////////////          //////////////.
  // Lead                                                                                                                      //                              //.
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(3).scale("e1:minor").sound("saw").gain(0.5).distort("0.05:soft:2").postgain(0.23).clip(0.65)
    .adsr("0.007:5.0:0.0:0.015").lpadsr("0.007:0.05:0.0:0.01").hpf(60).hpq(1.0).lpf(200).lpe(35).lpq(1.0)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.25).hpf(45).lpf(11500).adsr("0.002:0.10:0.5:0.2"),
