...
stack(                                                                                                                                     //        //.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                               //                              //.
    ...
    .hpf(1800).lpf(1550).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.3).lpadsr("0.008:2.0:0.0:0.015")                                   //       FOREVER!       //.
    .gain(0.60).distort("0.480:tube:4").postgain("<0.200!48 0.090!16 0.200!48 0.300!16>") // . solo()                                 //                  //.
    .adsr("0.008:4.0:0.0:0.03").clip(0.85).release("<0.08!16 0.15!16>").vibrato(8).vibmod(0.01)  // . mute()                           //       //      //.
  ...
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 0@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4                                
      ...
      [[-3,-7] [[-4,-5] [-1,-3]] [0,-3] <[[4 6],[0 -1]] [0,-1]>] [<[7,4] [[7 4 6 0]!4]> [-5 -6] [-7,-14] [-5 <-1 -4 -4 1>]]>/4`)
    ...
    .sound("supersaw").unison(9).spread(0.04).gain(0.75).postgain(0.105).distort("1:tube:4").distort(0.80)    
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.005:3.5:0.0:0.05").lpadsr("0.005:1.3:0.0:0.015")    
    .hpf("<550!16 450!16 550!16 650!16>").lpf("3200".add(saw.range(1, 0).pow(4.0).mul(200)).slow(8)).lpe(1.0).lpq(1.3)
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.80)).superimpose(hpf(3300).lpf(6000).lpq(0.5).postgain(0.05))
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .sound("supersaw").unison(11).spread(0.06).gain(0.75).postgain(0.11).distort("1:tube:4").distort(0.85)
    .clip("<0.87!31 0.77 0.87!31 0.85 0.87!30 0.81 0.72>".fast(2)).adsr("0.007:3.5:0.0:0.05").lpadsr("0.007:1.2:0.0:0.015")    
    .hpf(110).lpf(2400).lpe(1.0).lpq(1.1)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.10).hpf(240).lpf(3100).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-7 -3] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
           .pan(0.2).superimpose(pan(0.8))
    ).superimpose(hpf(3100).lpf(5200).lpq(0.5).postgain(0.03)).mute("<0!128 1!16 0!16>").pipeline("pedal").body("spruce").bodyMix(0.3)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.94 0.96 0.94".fast(2))  // . mute()
    .orbit(3).scale("e1:minor").sound("sine").gain(1.0).distort("0.2:soft:4").postgain(0.100).clip(0.60)
    .adsr("0.008:3.0:0.0:0.015").lpadsr("0.005:0.05:0.0:0.01").hpf(50).lpf(220).lpe(20).lpq(0.7)  //  .solo()
  ...
  ,master(Master.of(MasterFx.reverb().wet(0.03).damp(0.8).roomSize(8),
                    MasterFx.gain(1.35),   // +3.2 dB                                                                                                                                                                                            
                    MasterFx.limiter().lookahead(0.005).thresholdDb(-8.0).ratio(2.0).kneeDb(6.0).attack(0.015).release(0.125),                                                                                                                                    
                    MasterFx.gain(1.30),   // +2.9 dB                                                                                                                                                                                            
                    MasterFx.limiter().lookahead(0.005).thresholdDb(-4.0).ratio(4.0).kneeDb(4.0).attack(0.008).release(0.075),                                                                                                                                    
