...
let snd  = 450 // sine.range(125, 300).slow(11).add(sine.range(125, 300).slow(13))   // 100 .. 2000                          //      //
                                                                                                                            //        //
stack(                                                                                                         //////////////          //////////////
  // Lead                                                                                                        //                              //
  n("<[-7 0 2 4] [-7 0 4 2] [-5 -1 2 4] [-6 -1 3 1]>*2")                                                           //          DISCO!          //
    .orbit(0).scale("e4:minor").sound("supersaw").unison(16).detune(0.08)                                            //       FOREVER!       //
    .hpf(650).lpf(1200).lpe(3.5).lpadsr("0.02:0.2:0.7:0.1").warmth(0.3)                                                //                  //
    .gain(0.70).distort("0.2:gentle:2").postgain(0.50) // . solo()                                                      //       //      //
    .adsr("0.02:0.2:0.7:0.1").clip(0.9)                                                                                //     //    //    //
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!8]!14 [x!12]!2 [x!8]!32>").fast(2).velocity("1.02 0.95!3 0.98 0.95!3".fast(2))
    ...
    .notchf(snd).notchq(0.75).lpf(saw.range(850, 1200).slow(4)).hpf(100).lpe(1.2).distort("0.1:soft:2")
  ...
  sound("<[hh hh oh hh]!48 [cr hh cr hh]!16 [0 hh 0 hh]!16>").fast(2).mute("<0!160 1!32>") //. solo()
    .late(0.004).orbit(4).gain(0.95).crush(10).crushos(2).hpf(800).lpf("3500:1:1.5").adsr("0.01:0.2:0.5:0.1")
  // Master
