...
stack(                                                                                                                                     //        //.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                               //                              //.
    ...
    .hpf(1800).lpf(1650).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.5).lpadsr("0.007:1.5:0.0:0.02")                                   //       FOREVER!       //.
    .gain(0.60).distort("0.495:tube:4").postgain("<0.200!48 0.090!16 0.200!48 0.310!16>") // . solo()                                 //                  //.
  ...
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 0@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4                                 
    ...
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.005:3.5:0.0:0.031").lpadsr("0.005:1.3:0.0:0.011")    
    .hpf("<550!16 450!16 550!16 650!16>").lpf("3300".add(saw.range(1, 0).pow(3.0).mul(300)).slow(8)).lpe(1.0).lpq(1.4)
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.80)).superimpose(hpf(3300).lpf(6000).lpq(1.0).postgain(0.05))
    .pipeline("pedal").body("violin").bodyMix(0.2)
  , // Guitar 2
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.005:3.5:0.0:0.032").lpadsr("0.005:1.2:0.0:0.01")    
    .hpf(110).lpf(1600).lpe(1.0).lpq(1.3)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.10).hpf(220).lpf(3150).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-7 -3] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
           .pan(0.2).superimpose(pan(0.8))
    ).superimpose(hpf(3150).lpf(5200).lpq(1.0).postgain(0.05)).mute("<0!128 1!16 0!16>").pipeline("pedal").body("rosewood").bodyMix(0.2)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.94 0.96 0.94".fast(2))  // . mute()
    .orbit(3).scale("e1:minor").sound("sine").gain(1.0).distort("0.2:soft:4").postgain(0.10).clip(0.60)
    .adsr("0.015:3.0:0.0:0.015").lpadsr("0.005:0.05:0.0:0.01").hpf(45).lpf(160).lpe(30).lpq(0.7)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.26).hpf(45).lpf(11500).adsr("0.002:0.12:0.5:0.2"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>") // . solo()
    .pan(0.485).late(0.0025).orbit(5).gain(0.32).hpf(350).lpf(11500).adsr("0.002:0.20:0.2:0.2")
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.515).late(0.0005).orbit(5).gain(0.34).hpf(800).lpf("11500".add(perlin.mul(300).fast(4))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("<~!79 [~ ~ ~ cp  cp ~ cp ~] ~!47 [~ ~ ~ cp  cp ~ cp ~]>").orbit(6).gain(0.13).mute("<0!128 1!32>"),
  sound("pink!8").orbit(7).gain(0.05).hpf(5000).lpf(15000).lpq(0.5)
    .pan(sine.range(0.4, 0.6).slow(11)).adsr("0.005:0.25:0.0:0.05")  // .solo()
  // Master
  ,master(Master.of(MasterFx.reverb().wet(0.05).damp(0.9).roomSize(8), MasterFx.gain(2.7), MasterFx.limiter()))
