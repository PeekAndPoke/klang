...
stack(                                                                                                         //////////////          //////////////
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd ~  bd ~ ]!24 [bd bd bd bd]!24>").mute("<0!128 1!32>")  // . solo()
    .orbit(5).gain(0.95).hpf(80).lpf(6000).adsr("0.005:0.15:0.1:0.1"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd ~  sd]!24 [~  sd ~  sd]!24>").mute("<0!128 1!32>") // . solo()
    .late(0.001).orbit(5).gain(0.95).hpf(190).lpf(6500).adsr("0.006:0.25:0.1:0.1").superimpose(bandf(200).bandq(4).gain(0.4)),
  sound("<[hh hh oh hh]!48 [cr hh cr hh]!16 [0 hh 0 hh]!16>").fast(2).mute("<0!128 1!32>")  //  . solo()
    .late(0.002).orbit(5).gain(0.90).hpf(4000).lpf(6800).adsr("0.01:0.2:0.5:0.2") // . mute()
  // Master
