...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                          //          DISCO!          //
    ...
    .gain(0.50).distort("0.570:tube:4").postgain("<0.230!48 0.120!16 0.230!48 0.300!16>") // . solo()                           //       //      //
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .sound("supersaw").unison(7).detune(0.09).gain(0.75).postgain(0.115).distort("1:tube:4").distort(0.85)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.1:soft:2").postgain(0.23).clip(0.6)
    .adsr("0.004:3.0:0.0:0.015").lpadsr("0.004:0.1:0.0:0.01").hpf(70).hpq(1.25).lpf(200).lpe(20).lpq(1.2)  //  .solo()
  ...
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.475).late(0.002).orbit(6).gain(0.30).hpf(350).lpf(11500).adsr("0.002:0.10:0.2:0.2")
  ...
  sound("pink!8").gain(0.08).hpf(10000).pan(sine.range(0.25, 0.75).slow(3)).adsr("0.008:0.3:0.0:0.01") //  .solo(),
  // Master
