...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[7 [4@4 2 -1] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.85)).superimpose(hpf(4000).lpf(6500).postgain(0.04))
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .hpf(120).lpf(2000).lpe(0.8).lpq(1.6)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.12).hpf(240).hpf(2400).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-3 [-5 -3@3]] 4!7 [2 [3 4@3]]!1 4!7 [-4 [2 4@3]]>")
           .pan(0.2).superimpose(pan(0.8))
    ).superimpose(hpf(4500).lpf(5500).postgain(0.04)).mute("<0!128 1!16 0!16>").engine("pedal").body("wood").bodyMix(0.30)
  , // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.1:soft:2").postgain(0.26).clip(0.6)
    .adsr("0.004:3.0:0.0:0.015").lpadsr("0.004:0.15:0.0:0.01").hpf(80).hpq(1.25).lpf(200).lpe(10).lpq(1.2)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.26).hpf(45).lpf(10500).adsr("0.003:0.10:0.5:0.2"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.475).late(0.002).orbit(6).gain(0.27).hpf(350).lpf(9500).adsr("0.002:0.10:0.2:0.2")
    .superimpose(x => x.bandf("205".add(berlin.mul(10))).bandq(4).vel(0.80).hpf(150).lpf(550)),
