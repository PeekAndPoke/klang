...
stack(                                                                                                         //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                //          DISCO!          //
    ...
    .gain(1.00).distort("0.300:tube:4").postgain("<0.850!48 0.375!16>") // . solo()                                     //       //      //
    .adsr("0.01:3.0:0.0:0.05").adsrCurves("exp:exp:exp").clip(0.8)  // . mute()                                        //     //    //    //
  ...
  n(`<[7 4 2 <-1 4 1 3> [0 -1 -3 -1] [0 -3] -2 <[-1 4@3] [5 6@3] [4 7@3] [4 6@3]>]!4
    ...
    .gain(0.6).postgain(0.35).hpf("<360!48 600!16 360!32 600!32>").lpq(1.5).lpf(saw.range(1,0).pow(1.5).mul(1000).add(1200).slow(4)).lpe(1.0).lpq(2.00)
  ...
  n("<0 0 2 4 0 0 -2 -1>") //  . solo()
    ...
    .analog(feel).sound("supersaw").unison(15).detune(0.12)
    .hpf(180).hpq(1.0).lpf(1800).lpe(1.0).lpq(1.50)
    ...
    .pan(0.4).postgain(0.285).superimpose(
      x => x.pan(0.6),
      x => x.postgain(0.25).hpf(200).lpf(2000) // .lpe(1.0)
