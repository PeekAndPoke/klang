...
stack(                                                                                                         //////////////          //////////////
  ...
  n("<[-7 0 2 4] [-7 0 4 2] [-5 -1 2 4] [-6 -1 3 1]>*2")                                                           //          DISCO!          //
    ...
    .hpf(600).lpf(1800).lpe(1.5).lpadsr("0.02:0.25:0.70:0.1").warmth(0.1)                                              //                  //
  ...
  n(`<[7 4 2 <4 -1 4 3> [0 -1 -3 -1] [0 -3] -2 <[-1 4@3] [5 6@3] [1 2@3] [2 3@3]>]!4 
    ...
    .lpf(800).lpq(0.8).lpe(2.5).hpf("<240!48 360!16>")
    ...
    .superimpose(
      x => x.lpadsr("0.023:0.3:0.5:0.15").lpf(2200).scaleTranspose(7).postgain(0.95).pan(0.2).hpf(400).lpe(0.6).superimpose(pan(0.8))
    )
  ,
  // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!8]!14 [x!12]!2 [x!8]!32>").fast(2).velocity("1.02 0.95!3 0.98 0.95!3".fast(2))
    ...
    .lpf(300).lpe(5.0).hpf(80).distort("1.0:tube:4")
    ...
    .superimpose(
      x => x.lpf(2000).lpe(0.6).lpadsr("0.021:0.175:0.5:0.15")
