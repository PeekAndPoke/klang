...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[7 4 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .clip("<0.86!31 0.78 0.86!31 0.85 0.86!30 0.81 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.036").lpadsr("0.005:1.0:0.0:0.01")    
    .hpf("<500!16 450!16 500!16 750!16>").lpf("3200".add(saw.range(1, 0).pow(1.8).mul(800)).slow(4)).lpe(0.5).lpq(1.2)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.86!31 0.78 0.86!31 0.85 0.86!30 0.81 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.036").lpadsr("0.005:1.0:0.0:0.01")    
    .hpf(180).lpf(2800).lpe(0.5).lpq(1.1)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.1:soft:2").postgain(0.23).clip(0.7)
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.23).hpf(35).lpf(8500).adsr("0.004:0.15:0.5:0.2"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.475).late(0.002).orbit(6).gain(0.225).hpf(180).lpf(8200).adsr("0.005:0.15:0.2:0.2")
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.525).late(0.0005).orbit(7).gain(0.31).hpf(800).lpf(7500).adsr("0.005:0.15:0.8:0.2"), // . mute()
