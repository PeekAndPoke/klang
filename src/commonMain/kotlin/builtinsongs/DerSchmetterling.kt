...
stack(                                                                                                           //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                    //          DISCO!          //
    ...
    .gain(0.50).distort("0.550:tube:4").postgain("<0.600!48 0.260!16>") // . solo()                                       //       //      //
  ...
  n(`<[7 4 2 <-1 3 1 3> [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .clip("<0.88!31 0.80 0.88!31 0.85 0.88!30 0.82 0.73>".fast(2)).adsr("0.004:4.0:0.0:0.012").adsrCurves("exp:exp:exp").lpadsr("0.004:1.2:0.0:1.02")    
    .hpf("<500!48 800!16>").lpf(2300).lpe(0.975).lpq(1.5).warmth(0.05)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.88!31 0.80 0.88!31 0.85 0.88!30 0.82 0.73>".fast(2)).adsr("0.004:4.5:0.0:0.012").adsrCurves("exp:exp:exp").lpadsr("0.004:1.2:0.0:1.02")    
    .hpf(130).hpq(1.0).lpf(2300).lpe(0.975).lpq(1.2).warmth(0.05)
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!24 [bd bd bd bd]!24>").mute("<0!128 1!32>") //  . solo()
    .orbit(5).gain(0.80).hpf(100).lpf(5000).adsr("0.005:0.2:0.5:0.5"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!24 [~    sd    ~    sd]!24>").mute("<0!128 1!32>")  // . solo()
    .late(0.003).orbit(6).gain(0.475).hpf(210).lpf(5000).adsr("0.005:0.3:0.7:0.5").superimpose(x => x.bandf(200).bandq(4).gain(0.375)),
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!16 [cr hh cr hh]!24 [~ hh ~ hh]!24>").fast(2).mute("<0!128 1!32>")  //  . solo()
    .late(0.002).orbit(7).gain(0.70).hpf(1200).lpf(5500).adsr("0.005:0.3:0.7:0.5") // . mute()
  // Master
).room("0.2:5:0.1")
