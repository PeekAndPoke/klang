...
stack(                                                                                                         //////////////          //////////////
  ...
  n("<[-7 0 2 4] [-7 0 4 2] [-5 -1 2 4] [-6 -1 3 1]>*2")                                                           //          DISCO!          //
    ...
    .superimpose(                                                                                                    // //               // //
      x => x.shuffle("<1!64 0!16 1!1 4/8!14 1!33>").seed(sinOfNight.add(1).mul(24 * 60 * 15))                       //                       //
        .superimpose(transpose(12).detune(0.15).velocity("<0!32 0.20!32>").lpf(1500).pan(0.2).early(0.001))
        .superimpose(transpose(12).detune(0.20).velocity("<0!32 0.20!32>").lpf(1600).pan(0.8).late(0.001))
  ...
  n(`<[7 4 2 <4 -1 4 3> [0 -1 -3 -1] [0 -3] -2 <[-1 4@3] [5 6@3] [1 2@3] [2 3@3]>]!4 
      [[4 2] [0 -3] 0 [2 [2 6@3]]]!2 [0 [2 4] -3 <[4 1] [-2 0]>] [<0 -3> [2 -10] -7 [-2 <3 -6>]]>/4`)
    ...
    .lpf(1000).lpq(0.8).lpe(1.75).hpf("<240!48 360!16>")
    .distort("1.0:tube:4").distort(sine.range(0.3, 0.6).slow(10*32))
    .adsr("0.015:0.15:0.66:0.13").lpadsr("0.025:0.175:0.66:0.15").clip(0.50).crush(saw.range(8, 4).slow(32)) // . solo()
    .gain(0.3).postgain(0.95).orbit(1).pan(0.4).late(0.001)
    .superimpose(
      x => x.lpadsr("0.033:0.3:0.5:0.15").lpf(2000).scaleTranspose(7).postgain(0.95).pan(0.2).hpf(400).lpe(0.6).superimpose(pan(0.8))
    )
  ,
  // Bass
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!8]!14 [x!12]!2 [x!8]!32>").fast(2).velocity("1.02 0.95!3 0.98 0.95!3".fast(2))
    ...
    .lpf(200).lpe(5.75).hpf(80).distort("1.0:tube:4")
    .adsr("0.017:0.15:0.66:0.13").lpadsr("0.027:0.15:0.5:0.15").clip(0.50) //  . solo()
    .gain(0.3).postgain(0.9).orbit(2).pan(0.5).mute("<0!128 1!16 0!16>")
    .superimpose(
      x => x.lpf(2000).lpe(0.6).lpadsr("0.022:0.15:0.5:0.15")
            .scaleTranspose("<4!8  4!2 [4 [4,7] 4 [4,7]] 4  4!2 [4 [4,7] 4 [4,0]] [2 4]>").postgain(0.8).pan(0.33).hpf(160).superimpose(pan(0.66))
    )
  ,
  // Drums
