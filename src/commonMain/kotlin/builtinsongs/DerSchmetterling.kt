...
stack(                                                                                                                                     //        //.
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                               //                              //.
    ...
    .hpf(1800).lpf(1600).lpe(berlin.range(2, 2.10).fast(4)).lpq(2.2).lpadsr("0.015:1.7:0.0:0.02")                                   //       FOREVER!       //.
  ...
  n(`<[7 [4@4 2 0] 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 0@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4                                
    ...
    .coarse(2).coarseos(4).pan(0.15).superimpose(pan(0.80)).superimpose(hpf(3300).lpf(6500).lpq(0.7).postgain(0.05))
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .sound("supersaw").unison(9).spread(0.09).gain(0.75).postgain(0.105).distort("1:tube:4").distort(0.85)
    .clip("<0.86!31 0.77 0.86!31 0.85 0.86!30 0.81 0.72>".fast(2)).adsr("0.007:3.5:0.0:0.032").lpadsr("0.005:1.2:0.0:0.01")    
    .hpf(110).lpf(2000).lpe(1.0).lpq(1.2)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.095).hpf(240).lpf(3150).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-7 -3] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
  ...
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>") // . solo()
    .pan(0.5).late(0.0015).orbit(5).pan(0.475).gain(0.31).hpf(350).lpf(13500).adsr("0.002:0.20:0.2:0.2")
  ...
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.525).late(0.0030).orbit(5).gain(0.34).hpf(800).lpf("12000".add(perlin.mul(300).fast(4))).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("<~!79 [~ ~ ~ cp  cp ~ cp ~] ~!47 [~ ~ ~ cp  cp ~ cp ~]>").orbit(6).gain(0.13).mute("<0!128 1!32>"),
  sound("pink!8").orbit(7).gain(0.08).hpf(5000).lpf(15000).lpq(0.5)
  ...
  ,master(Master.of(MasterFx.reverb().wet(0.03).damp(0.8).roomSize(8),
                    MasterFx.gain(1.3), MasterFx.limiter().lookahead(0.0050).attack(0.0050),
                    MasterFx.gain(1.7), MasterFx.limiter().lookahead(0.0050).attack(0.0030),
                    MasterFx.gain(1.2), MasterFx.limiter().lookahead(0.0050).attack(0.0010),
  ))
