...
stack(                                                                                                         //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                  //          DISCO!          //
    ...
    .gain(1.00).distort("0.350:tube:4").postgain("<0.750!48 0.350!16>") // . solo()                                     //       //      //
  ...
  n(`<[7 4 2 <-1 4 1 3> [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [4 9@3] [4 3@3]>]!4
    ...
    .sound("supersaw").unison(9).detune(0.08).gain(0.8).postgain(0.31).distort("1.0:tube:4").distort(1.0).vibrato(4).vibmod(0.02)    
    .clip("<0.93!31 0.80 0.93!31 0.70>".fast(2)).adsr("0.005:1.5:0.1:0.005").adsrCurves("exp:exp:exp").lpadsr("0.005:1.0:0.4:0.005")    
    .hpf("<320!48 440!16 320!48 440!16>").lpf(saw.range(1,0).pow(2.0).mul(500).add(1000).slow(4)).lpe(3.0).lpq(1.25)
    .coarse(2).coarseos(4).pan(0.2).superimpose(pan(0.8))
  ...
  n("<0 0 2 4 0 0 -2 -1>") //   . solo()
    ...
    .sound("supersaw").unison(5).detune(0.07).gain(0.8).postgain(0.27).distort("1:tube:2").distort(1.0)
    ...
    .coarse(2).coarseos(4).pan(0.35).superimpose(
      x => x.pan(0.65),
      x => x.orbit(3).postgain(0.24).hpf(180).lpf(1025) // .lpe(1.0)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!32 [x@3 x]!32 [x!4]!64>").fast(2).velocity("1.00 0.9!3 0.95 0.90!3".fast(4)) // . mute()
    .scale("<e2:minor!88 e2:minor!8>").sound("saw").gain(0.5).distort("0.2:tube:1").postgain(0.525).clip(0.9)
    .adsr("0.010:0.8:0.1:0.03").adsrCurves("exp:exp:exp").lpadsr("0.010:0.5:0.0:0.15").hpf(60).hpq(1.25).lpf(100).lpe(1.5).hpq(1.5) //  .solo()
    .mute("<0!128 1!32>") // .engine("pedal")
  , // Drums
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd ~  bd ~ ]!24 [bd bd bd bd]!24>").mute("<0!128 1!32>")  // . solo()
    .early(0.001).orbit(5).gain(0.90).hpf(80).lpf(6000).adsr("0.005:0.15:0.1:0.1"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd ~  sd]!24 [~  sd ~  sd]!24>").mute("<0!128 1!32>") // . solo()
    .early(0.001).orbit(5).gain(0.95).hpf(180).lpf(6000).adsr("0.006:0.25:0.1:0.1").superimpose(bandf(200).bandq(4).gain(0.5)),
  sound("<[hh hh oh hh]!48 [cr hh cr hh]!16 [0 hh 0 hh]!16>").fast(2).mute("<0!128 1!32>")  //  . solo()
    .late(0.003).orbit(5).gain(0.85).hpf(4000).lpf(6500).adsr("0.01:0.2:0.5:0.2") // . mute()
  // Master
