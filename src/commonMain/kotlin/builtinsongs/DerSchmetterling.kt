...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                          //          DISCO!          //
    ...
    .hpf(1550).lpf(1550).lpe(berlin.range(2, 2.03).fast(4)).lpq(2.3).lpadsr("0.007:1.1:0.0:0.01")                              //                  //
    .gain(0.50).distort("0.570:tube:4").postgain("<0.210!48 0.100!16>") // . solo()                                             //       //      //
  ...
  n(`<[7 4 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .sound("supersaw").unison(9).detune(0.08).gain(0.75).postgain(0.14).distort("1:tube:4").distort(0.75)    
    .clip("<0.86!31 0.78 0.86!31 0.85 0.86!30 0.81 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.034").lpadsr("0.005:1.0:0.0:0.01")    
    .hpf("<500!16 480!16 500!16 750!16>").lpf("3300".add(saw.range(1, 0).pow(1.8).mul(800)).slow(4)).lpe(0.8).lpq(1.3)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .sound("supersaw").unison(7).detune(0.09).gain(0.75).postgain(0.12).distort("1:tube:4").distort(0.75)
    .clip("<0.86!31 0.78 0.86!31 0.85 0.86!30 0.81 0.71>".fast(2)).adsr("0.005:2.5:0.0:0.034").lpadsr("0.005:1.0:0.0:0.01")    
    .hpf(170).lpf(2700).lpe(0.8).lpq(1.2)
    .coarse(2).coarseos(4).pan(0.3).superimpose(
      x => x.pan(0.7),
      x => x.postgain(0.13).hpf(280).scaleTranspose("<4!7 [2 [3 4@3]]!1 4!7 [-3 [-4 -3@3]] 4!7 [2 [3 4@3]]!1 4!7 [-3 [2 4@3]]>")
           .pan(0.25).superimpose(pan(0.75)).superimpose(hpf(3000).postgain(0.05))
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!80>").fast(2).velocity("0.98 0.98 0.99 0.98".fast(2))  // . mute()
    .orbit(4).scale("e1:minor").sound("saw").gain(0.5).distort("0.1:soft:2").postgain(0.27).clip(0.6)
    .adsr("0.004:2.5:0.0:0.015").lpadsr("0.004:0.15:0.0:0.01").hpf(50).lpf(200).lpe(15)  //  .solo()
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.22).hpf(35).lpf(10500).adsr("0.004:0.15:0.5:0.2"),
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>")  // . solo()
    .pan(0.475).late(0.002).orbit(6).gain(0.275).hpf(5000).lpf(8500).adsr("0.005:0.15:0.2:0.2")
    .superimpose(x => x.bandf("200".add(berlin.mul(10))).bandq(4).vel(0.90).hpf(180).lpf(5500)),
  sound("<[hh hh hh hh]!16 [hh hh oh hh]!24 [cr hh cr hh]!24 [~ rd ~ rd]!32>").fast(2).mute("<0!128 1!32>") // . solo()
    .pan(0.525).late(0.0005).orbit(7).gain(0.31).hpf(800).lpf(7800).adsr("0.005:0.15:0.8:0.2"), // . mute()
  sound("pink!8").gain(0.08).hpf(8000).pan(sine.range(0.35, 0.65).slow(3)).adsr("0.008:0.3:0.0:0.01") //  .solo(),
  // Master
