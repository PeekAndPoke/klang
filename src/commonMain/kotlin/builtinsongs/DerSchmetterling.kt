...
let guitar = (() => {
  ...
  let signal = Osc.supersaw(freq = Osc.freq(), voices = pVoices, spread = pSpread)
    ...
    .phasePool(on = 1, kMin = 0.55, kMax = 0.85)
...
stack(    
  stack(
    ...
    n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|[5 3]|3|3|3 [1 -1]|1|1|1|1]>*2`)
      ...
      .gain(0.325).postgain("<0.200!48 0.095!16 0.200!48 0.270!16>")  // . solo()                  
    ...
    n(`<[0 [0@4 [4 7] -3] -1 <4 3 1> [0 2 4 3] 0 2 <[-1 1 3@2] [[3 4] 6@2 7] [[1 3] 4 3 2] [[6 10 7 5]]>]!4
        ...
        [[-3,-7] [[-4,-8] [-1,-4]] [0,-3] <[[4 6],[-2 3]] [0,-1]>] [<[7,4] [[7 4 6 0  7 4 2 0]!2]> [1 0 2 0] 0 [[-2 0 1 2] 4]]>/4`)
      .orbit(1).scale("<e3:minor!48 e4:minor!16 e3:minor!48 e4:minor!16>").struct("<[x!16]!7 [x!24]!1 [x!16]!16>") //  .mute()
      .gain(0.5).postgain(0.140).velocity("0.98 0.95!7 0.97 0.95!7".fast(2))  // . solo()
      .sound(guitar).unison(15).spread(0.07).oscp("presenceHz", 2900)  
    ...
    n(`<[11 11 9 8  7 7 9 6] [11 11 [13 11] 8   7  7 5  6] [11 11 9 11  7 7 7 8] [11 11 [13  9] 4      7 4         2         3]
      ...
      .gain(0.5).postgain(0.135).velocity("0.98 0.95!7 0.97 0.95!7".fast(2)) // . solo()
      .sound(guitar).unison(11).spread(0.09).oscp("presenceHz", 2600).oscp("hptrack", 1.20)
      ...
      .coarse(2).coarseos(8).body("cedar").bodyMix(0.5)
    , // Guitar 3
    n(`<[0 0 2 4 0 0 -2 -1]!4
  ...
  stack(  
    ...
    sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd  ~ sd]!32 [~ sd ~ sd]!32>").mute("<0!128 1!32>") // . solo()
      .pan(0.5).late(0.0015).orbit(5).pan(0.45).gain(0.17).hpf(80).lpf(16000).lpq(0.5).adsr("0.000:0.05:0.95:0.2")
    ...
    sound("<pink ~ pink pink>*16").orbit(5).gain(0.145).hpf(10000).velocity("<1.0 0.85 0.95 0.85>*16")
      .pan(sine.range(0.35, 0.65).slow(8)).adsr("0.006:0.15:0.0:0.01") //  .solo()
