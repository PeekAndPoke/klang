...
stack(                                                                                                         //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                  //          DISCO!          //
    ...
    .gain(0.50).distort("0.590:tube:4").postgain("<0.600!48 0.300!16>") // . solo()                                     //       //      //
  ...
  n(`<[7 4 2 <-1 3 1 3> [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .sound("supersaw").unison(17).detune(0.10).gain(0.8).postgain(0.27).distort("1:diode:4").distort(0.8)    
    .clip("<0.88!31 0.80 0.88!31 0.91 0.88!30 0.80 0.73>".fast(2)).adsr("0.006:4.0:0.1:0.02").adsrCurves("exp:exp:exp").lpadsr("0.006:2.0:0.3:0.007")    
    .hpf("<450!48 780!16>").lpf(saw.range(1,0).pow(2.0).mul(500).add(1475).slow(4)).lpe(2.3).lpq(0.8)
  ...
  n("<0 0 2 4 0 0 -2 -1>")  //  . solo()
    ...
    .clip("<0.88!31 0.80 0.88!31 0.91 0.89!30 0.80 0.73>".fast(2)).adsr("0.004:5.0:0.0:0.012").adsrCurves("exp:exp:exp").lpadsr("0.004:2.0:0.3:0.005")    
    .hpf(120).lpf(1450).lpe(2.3).lpq(0.8)
    .coarse(2).pan(0.35).superimpose(
      x => x.pan(0.65),
      x => x.orbit(3).postgain(0.24).hpf(120).lpf(1450) // .lpe(1.0)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!16 [x@3 x]!48 [x!4]!48>").fast(2).velocity("1.00 0.93!3 0.95 0.93!3".fast(2)) // . mute()
    .orbit(4).coarse(2).scale("<e2:minor!88 e2:minor!8>").sound("saw").gain(0.5).distort("0.3:tube:1").postgain(0.58).clip(0.7)
