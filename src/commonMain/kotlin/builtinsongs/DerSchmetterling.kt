...
stack(                                                                                                                 //////////////          //////////////
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)                          //          DISCO!          //
    ...
    .gain(0.50).distort("0.570:tube:4").postgain("<0.220!48 0.100!16>") // . solo()                                             //       //      //
  ...
  n(`<[7 4 2 1 [0 -1 -3 -1] [0 -3] -2 <[-1 5@3] [5 6@3] [[4 5] 8@3] [[3 4] 3@3]>]!4
    ...
    .hpf("<450!16 380!16 450!16 750!16>").lpf("3000".add(saw.range(1, 0).pow(1.8).mul(500)).slow(4)).lpe(0.5).lpq(1.1)
  ...
  sound("<[bd!2]!2 [bd!4]!2 [bd!8]!2 [bd!16] [bd!24] [bd  ~ bd  ~]!32 [bd!4]!16 [bd ~ bd [~ bd]]!15 [bd!]!1>").mute("<0!128 1!32>")  // . solo()
    .pan(0.5).orbit(5).gain(0.24).hpf(35).lpf(7500).adsr("0.004:0.2:0.5:0.2"),
