...
let feel = 18.0    // 0.0 .. guitar | 100.0 .. rave
...
let supersawHp = (() => {
  ...
  let signal = Osc.supersaw(freq = Osc.freq(), voices = pVoices, spread = pSpread)
    ...
    .add(Osc.supersaw(freq = Osc.freq().mul(2), voices = pVoices, spread = pSpread).mul(0.25))
...
stack(                                                                                                                  
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|[5 3]|3|3|3 [1 -1]|1|1|1|1]>*2`)                  
    ...
    .gain(0.50).distort("0.440:tube:4").postgain("<0.200!48 0.110!16 0.200!48 0.280!16>") // . solo()                  
  ...
  n(`<[0 [0@4 [4 7] -3] -1 -3 [0 2 4 3] 0 2 <[-1 1 3@2] [[3 4] 6@2 7] [[1 3] 4 3 2] [[6 12 7 5]]>]!4
    ...
    .hpf("<600>").lpf("3000".add(saw.range(1, 0).pow(4.0).mul(200)).slow(8)).lpe(1.2).lpq(0.7)
  ...
  n("<0 0 2 4 0 0 -2 -1>") //   . solo()
    ...
    .hpf(80).lpf(2600).lpe(1.0).lpq(0.7)
