...
internal val finalFantasy7PreludeSong = Song(
    id = "${BuiltInSongs.PREFIX}-final-synthasy-7-prelude",
...
stack(
  ...
  .fast(2).scale("C3:major")
  .sound("sine").hpf(130).warmth(0.4).gain(0.5).clip(0.5)
