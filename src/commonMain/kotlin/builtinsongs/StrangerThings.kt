...
stack(
  ...
  n("<[0 2 4 6 7 6 4 2]!14 [-2 -1 0 2 4 2 0 -1] [-2 -1 2 6 4 2 0 -1]>")
    ...
    .hpf(350).lpf(800).lpenv(perlin.range(3.0, 4.5).slow(8)).analog(3)
  ...
  note("<a1 [f1 c2 e1 [f2 c2]] [a1 [c2 f1] a1 [f1@3 e1]] [a1@2 c2@3 d2 [c2,c3] [d1,d1,d2]]>/8").clip(0.8).struct("x!8")
    ...
    .lpf(4 * 440).hpf(90).notchf(notch).notchq(0.75).analog(2)
    .superimpose(x => x.gain(saw.slow(64).pow(1.5).mul(2.0)).crush("1.5".add(berlin2.mul(0.25).slow(4))).lpf(4.5 * 440).hpf(300).postgain(0.4).late(0.002))
  ...
  sound("<[hh hh oh hh] [hh hh ~ hh] [hh hh oh hh] [hh hh ~ <cr!7 rd>]>")
    .orbit(4).gain(0.6).pan(0.4).adsr("0.04:0.2:0.8:2.0").fast(2).degrade(0.1).lpf(4800).late(0.002)
