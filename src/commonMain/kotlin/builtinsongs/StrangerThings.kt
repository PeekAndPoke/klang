...
stack(
  ...
  note("<a1 [f1 c2 e1 [f2 c2]] [a1 [c2 f1] a1 [f1@3 e1]] [a1@2 c2@3 d2 [c2,c3] [d1,d1,d2]]>/4").clip(0.8).struct("x!4").slow(16)
    .orbit(2).s("supersaw").unison(4).detune(saw.range(0.05, 0.45).slow(64)).warmth(0.1)
    .gain(1.0).adsr("0.01:0.6:0.8:1.80").postgain(0.4)
    .superimpose(
    ...
    .superimpose(
      x => x.gain(saw.range(0.2, 1.0).slow(64).pow(1.5).mul(2.5)).vibrato(16).vibmod(0.2)
