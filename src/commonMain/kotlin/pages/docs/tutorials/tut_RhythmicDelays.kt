...
val rhythmicDelaysTutorial = Tutorial(
    ...
    sections = listOf(
        ...
        TutorialSection(
            ...
            code = """sound("cp ~ ~ ~")
  // Try: delay on, delaytime sets the echo interval, feedback seasons the repeats
  .delay(1).delaytime(0.25).delayfeedback(0.4)
  .gain(0.6)""",
        ),
        TutorialSection(
  ...
  .room(0.15).rsize(4.0).gain(0.4)""",
        ...
        TutorialSection(
            ...
            code = """n("0 4 7 ~").scale("C3:minor")
  .sound("saw").lpf(1200)
  .delay(1).delaytime(0.25).delayfeedback(0.6)
  .gain(0.3)""",
        ),
        TutorialSection(
  ...
  n("0 ~ 4 ~ 7 ~ 4 ~").scale("C3:minor")
    ...
    .gain(0.25).orbit(0),
  sound("rim ~ ~ ~")
    .delay(1).delaytime(0.166).delayfeedback(0.6)
    .pan(0.5).gain(0.4).orbit(1),
