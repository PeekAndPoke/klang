    ...
    sections = listOf(
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Markdown(
                    markdown = """
                    Add the octave on top (`a2`, `e3`, `a3`), and you have the **power chord**: three notes that behave like one big one. Which notes agree like this, and which clash, is what harmony is about. A chords lesson still to come takes that up properly. Here, this one shape is enough.

                    The riff below (a short figure that repeats) stabs it three times across the cycle: on the first step, on the fourth, and on the seventh, with rests carrying the time between. (Three notes add up further, so the line drops to 0.35.)
