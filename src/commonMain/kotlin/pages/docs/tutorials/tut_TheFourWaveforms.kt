...
val theFourWaveformsTutorial = Tutorial(
    ...
    sections = listOf(
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "The melody below is the one you ended ${Tut.firstNotes} with, sung by sine — the pure " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "A saw wave carries the full stack of overtones above every note — every extra " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "A square wave also stacks overtones, but only every second one — half the stack " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "A triangle wave carries the same every-second stack as the square — but far " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "One more voice, to mark the edge of the map: white noise — every frequency at " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "All four voices, one per line, and no correct answer: the notes carry the " +
