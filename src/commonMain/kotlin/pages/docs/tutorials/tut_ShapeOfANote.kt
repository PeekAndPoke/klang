...
val shapeOfANoteTutorial = Tutorial(
    ...
    sections = listOf(
        TutorialSection(
            ...
            text = "So far, every note held for its whole step and then stopped — that was a shape " +
        ...
        TutorialSection(
            ...
            text = "The first number is the fade-in, in seconds. Nearly zero means the note " +
        ...
        TutorialSection(
            ...
            text = "Sustain is the odd one out: it is a level, not a time. After the attack, the " +
        ...
        TutorialSection(
            ...
            text = "The last number is the fade-out after the note's step ends. The default 0.05 " +
        ...
        TutorialSection(
            ...
            text = "Three instruments, one voice, one phrase — nothing changes below but the four " +
