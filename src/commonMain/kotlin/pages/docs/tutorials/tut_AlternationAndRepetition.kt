...
val alternationAndRepetitionTutorial = Tutorial(
    ...
    sections = listOf(
        TutorialSection(
            ...
            text = "Angle brackets are the opposite of a sequence: instead of splitting one cycle " +
        ...
        TutorialSection(
            ...
            text = "The at-sign gives a step extra weight: a2@3 takes three shares of the cycle " +
        ...
        TutorialSection(
            ...
            text = "Everything from this lesson in one line: bars between < >, the first one " +
