...
val firstNotesTutorial = Tutorial(
    ...
    sections = listOf(
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "note() works exactly like sound() — names in quotes, spaces splitting the cycle into " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "Notes are named with seven letters — c d e f g a b — and then the ladder starts " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "The number after the letter picks the floor: c3 is low, c5 is high. Same letter, " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "The seven letters are not the whole ladder. Between most of them sits one more note — " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "Melodies move in two ways: to a neighbouring letter, or further. Musicians call " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "Steps, one leap, and two rests — the ideas this melody is built on, in one line. Let it loop; it is written to circle back on itself. The walking part in " +
        ...
        TutorialSection(
            ...
            blocks = listOf(
                Block.Text(
                    "One more version, for a question you may already be asking: how do you hold a " +
