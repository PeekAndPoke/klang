...
val shapeYourSoundTutorial = Tutorial(
    ...
    sections = listOf(
        ...
        TutorialSection(
            ...
            code = """n("0 2 4 6 7 6 4 2").scale("C3:minor").sound("saw").lpf(800).gain(0.4)""",
        ),
        TutorialSection(
            ...
            code = """n("0 2 4 6 7 6 4 2").scale("C3:minor").sound("saw").lpf(800).adsr("0.3:0.2:0.6:0.5").gain(0.4)""",
        ),
        TutorialSection(
            ...
            code = """n("0 2 4 6 7 6 4 2").scale("C3:minor").sound("saw").lpf(800).adsr("0.3:0.2:0.6:0.5").room(0.3).rsize(5.0).gain(0.4)""",
        ),
        TutorialSection(
            ...
            code = """n("0 ~ 4 ~").scale("C3:minor").sound("saw").lpf(600).adsr("0.01:0.1:0.3:0.2").delay(1).delaytime(0.33).delayfeedback(0.4).gain(0.4)""",
        ),
        TutorialSection(
