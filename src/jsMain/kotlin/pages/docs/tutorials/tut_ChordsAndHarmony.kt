...
val chordsAndHarmonyTutorial = Tutorial(
    ...
    sections = listOf(
        ...
        TutorialSection(
            ...
            code = """chord("<Am C F G>").voicing().sound("supersaw").lpf(600).adsr("0.1:0.3:0.7:0.5").gain(0.3)""",
        ),
        TutorialSection(
            ...
            code = """chord("<Am C F G>").voicing().sound("supersaw").lpf(600).adsr("0.1:0.3:0.7:0.5").gain(0.25).superimpose(transpose("12"))""",
        ),
        TutorialSection(
            ...
            code = """chord("<Am C F G>").voicing().sound("supersaw").lpf(600).adsr("0.1:0.3:0.7:0.5").gain(0.25).superimpose(transpose("12").pan(0.85)).pan(0.15)""",
        ),
        TutorialSection(
            ...
            code = """stack(
  chord("<Am C F G>").voicing().sound("supersaw").lpf(500).adsr("0.1:0.3:0.7:0.5").gain(0.2).superimpose(transpose("12").pan(0.85)).pan(0.15).room(0.15).rsize(4.0).orbit(0),
  n("<0 3 5 7>").scale("A2:minor").sound("saw").lpf(300).adsr("0.01:0.2:0.8:0.1").gain(0.4).orbit(1),
