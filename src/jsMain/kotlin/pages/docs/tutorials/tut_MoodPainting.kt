...
val moodPaintingTutorial = Tutorial(
    ...
    sections = listOf(
        TutorialSection(
            ...
            code = """n("0 2 4 5 7 5 4 2").scale("C3:minor").sound("saw").lpf(800).gain(0.4)""",
        ),
        TutorialSection(
            ...
            code = """stack(
  n("0 3 4 5 7 5 3 0").scale("C3:blues").sound("saw").lpf(600).adsr("0.01:0.1:0.6:0.2").gain(0.3),
  sound("bd hh sd hh"),
  sound("~ ~ cp ~").gain(0.7)
)""",
        ),
        TutorialSection(
            ...
            code = """stack(
  slowcat(
    n("0 2 4 7 5 4 2 0").scale("C3:minor").sound("saw").lpf(600).gain(0.3),
