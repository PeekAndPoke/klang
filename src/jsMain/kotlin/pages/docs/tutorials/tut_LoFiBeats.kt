...
val loFiBeatsTutorial = Tutorial(
  ...
  sound("hh hh hh hh hh hh hh hh").lpf(3000).crush(8).gain(0.3)
        ...
        TutorialSection(
            ...
            code = """chord("<Dm7 Fmaj7 Cmaj7 Em7>").voicing().sound("tri").lpf(600).adsr("0.05:0.3:0.7:0.5").room(0.2).rsize(4.0).gain(0.3)""",
        ),
        TutorialSection(
        ...
        TutorialSection(
            ...
            code = """stack(
  sound("bd ~ ~ bd ~ ~ bd ~").crush(10).gain(0.8).orbit(0),
  sound("~ ~ sd ~ ~ ~ sd ~").crush(10).gain(0.7).orbit(0),
  sound("hh hh hh hh hh hh hh hh").lpf(3000).crush(8).gain(0.3).orbit(0),
  chord("<Dm7 Fmaj7 Cmaj7 Em7>").voicing().sound("tri").lpf(600).adsr("0.05:0.3:0.7:0.5").room(0.2).rsize(4.0).gain(0.25).orbit(1),
  n("0 ~ 4 ~ 7 ~ 4 ~").scale("C4:pentatonic").sound("sine").lpf(2000).adsr("0.05:0.2:0.4:0.3").delay(1).delaytime(0.33).delayfeedback(0.3).gain(0.2).orbit(2),
  sound("brown").hpf(2000).crush(4).gain(0.03).orbit(3)
)""",
        ),
    ),
)
