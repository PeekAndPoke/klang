...
val ambientOrbitsTutorial = Tutorial(
    ...
    sections = listOf(
        ...
        TutorialSection(
            ...
            code = """n("<0 3 5 7>").scale("C3:minor").sound("supersaw").lpf(400).legato(2).adsr("0.5:0.5:0.8:1.0").room(0.3).rsize(8.0).gain(0.2)""",
        ),
        TutorialSection(
            ...
            code = """n("<7 5 3 0>").scale("C4:minor").sound("sine").hpf(2000).legato(2).adsr("0.8:0.3:0.6:1.5").room(0.4).rsize(10.0).gain(0.25)""",
        ),
        TutorialSection(
            ...
            code = """stack(
  n("<0 0 0 0>").scale("C2:minor").sound("sine").lpf(200).legato(2).adsr("0.3:0.5:0.9:0.5").orbit(0).gain(0.4),
  n("<0 3 5 7>").scale("C3:minor").sound("supersaw").lpf(400).legato(2).adsr("0.5:0.5:0.8:1.0").room(0.3).rsize(8.0).orbit(1).gain(0.2)
)""",
        ),
        TutorialSection(
            ...
            code = """n("0 ~ ~ 4 ~ ~ 7 ~").scale("C4:minor").sound("sine").legato(1.5).adsr("0.1:0.3:0.5:1.5").delay(1).delaytime(0.5).delayfeedback(0.3).room(0.3).rsize(6.0).gain(0.25)""",
        ),
        TutorialSection(
        ...
        TutorialSection(
            ...
            code = """stack(
  n("<0 0 0 0>").scale("C2:minor").sound("sine").lpf(200).legato(2).adsr("0.3:0.5:0.9:0.5").orbit(0).gain(0.35),
  n("<0 3 5 7>").scale("C3:minor").sound("supersaw").lpf(400).legato(2).adsr("0.5:0.5:0.8:1.0").phaser(1).room(0.3).rsize(8.0).orbit(1).gain(0.2),
  n("0 ~ ~ 4 ~ ~ 7 ~").scale("C4:minor").sound("sine").legato(1.5).adsr("0.1:0.3:0.5:1.5").delay(1).delaytime(0.5).delayfeedback(0.3).room(0.2).rsize(6.0).orbit(2).gain(0.2),
