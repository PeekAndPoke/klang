...
class CompletionProviderTest : StringSpec({
    ...
    "member: OscSlot shows all slot properties" {
        ...
        names.toSet().containsAll(
            listOf("analog", "voices", "detune", "duty", "density", "decay", "brightness", "pickPosition", "stiffness", "rate")
        ) shouldBe true
    }
    ...
    "member: OscSlot lookup by FQCN matches the same set" {
        ...
        names.toSet().containsAll(listOf("analog", "voices", "detune")) shouldBe true
    }
