...
| Feature                | Syntax                                                                         | Semantics                                                                 | KlangScript Test                                                                                |
|------------------------|--------------------------------------------------------------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| `NumberLiteral`        | `42`, `3.14`, `-42`, `2.pow(2)`                                                | stored as `Double`; integer rendered without decimal; a bare `-42` is one literal; a method call on a literal works, a negative receiver needs parentheses | `LiteralsTest.kt`, `parser/NumberLiteralMethodCallSpec.kt`                                    |
