...
| Feature                | Syntax                                                                         | Semantics                                                                 | KlangScript Test                                                                                |
|------------------------|--------------------------------------------------------------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| `NumberLiteral`        | `42`, `3.14`, `-42`, `2.pow(2)`                                                | stored as `Double`; integer rendered without decimal; `-` before a literal is part of it; a method call on a literal works | `LiteralsTest.kt`, `parser/NumberLiteralMethodCallSpec.kt`                                    |
