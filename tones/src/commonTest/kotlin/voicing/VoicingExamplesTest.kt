...
class VoicingExamplesTest : StringSpec({
    "Voicing.search" {
        ...
        val voicings = Voicing.search("C^7", listOf("E3", "D5"), dict)
    ...
    "Voicing.get" {
        ...
        Voicing.get("Dm7", listOf("F3", "A4"), lefthand, topNoteDiff) shouldBe
                listOf("F3", "A3", "C4", "E4")

        val last = listOf("C4", "E4", "G4", "B4")
        Voicing.get("Dm7", listOf("F3", "A4"), lefthand, topNoteDiff, last) shouldBe
                listOf("C4", "E4", "F4", "A4")
    }

    "Voicing.sequence" {
        val chords = listOf("Cmaj7", "Dm7", "G7", "Cmaj7")
        val sequence = Voicing.sequence(chords)
