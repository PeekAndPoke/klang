...
class ProgressionTest : StringSpec({
    "fromRomanNumerals" {
        ...
        inC("I II III IV V VI VII".split(" ")) shouldBe "C D E F G A B".split(" ")
        inC("bI bII bIII bIV bV bVI bVII".split(" ")) shouldBe "Cb Db Eb Fb Gb Ab Bb".split(" ")
        inC("#Im7 #IIm7 #III #IVMaj7 #V7 #VI #VIIo".split(" ")) shouldBe "C#m7 D#m7 E# F#Maj7 G#7 A# B#o".split(" ")
    }
