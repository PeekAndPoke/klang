...
- **D3, the filter envelope. DECIDED 2026-09-25 (maintainer), and widened to every modulation envelope:**
  ...
  (`lpadsr`, `pattack`, ...) were retired 2026-09-07, and the curves door is always `<door>Curves`; (5) the envelope frame counts
