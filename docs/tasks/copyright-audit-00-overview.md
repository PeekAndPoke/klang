...
|----|------------------------------------------------------------------------------------------------------------|--------------|-----------|------------------|
| 01 | [Rewrite `EuclideanMorphPattern.calculateMorphedArcs`](copyright-audit-01-euclidean-morph-rewrite.md)      | B (high)     | 🔴 must   | code             |
| 02 | [De-port Euclidean generation (Bjorklund + rotate)](copyright-audit-02-euclidean-generation-deport.md)     | B (high)     | 🔴 must   | code             |
