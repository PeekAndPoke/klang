# Ignitor / Oscillator Benchmark Suite

## Goal

Automated performance benchmarks for all oscillators and common ignitor compositions.
...
### Common compositions (ignitor chains)
