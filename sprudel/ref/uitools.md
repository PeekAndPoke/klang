...
|------------------------------------|-------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
| `SprudelNumericEditorTool.kt`      | Configurable numeric editor with drag bar                               | Gain, Pan, ReverbSize, DelayTime, DelayFeedback, all individual filter params (cutoff, resonance, env, attack, decay, sustain, release per filter type) |
