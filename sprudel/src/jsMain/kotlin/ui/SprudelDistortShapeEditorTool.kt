...
object SprudelDistortShapeEditorTool : KlangUiToolEmbeddable {
    override val title: String = "Distort Shape"

    override val iconFn: SemanticIconFn = { bolt }

    override fun FlowContent.render(ctx: KlangUiToolContext) {
        SprudelDistortShapeEditorComp(ctx, embedded = false)
    }

    override fun FlowContent.renderEmbedded(ctx: KlangUiToolContext) {
        SprudelDistortShapeEditorComp(ctx, embedded = true)
    }
}
...
private fun Tag.SprudelDistortShapeEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelDistortShapeEditorComp.Props(toolCtx, embedded)) { SprudelDistortShapeEditorComp(it) }

// ── Component ─────────────────────────────────────────────────────────────────

private class SprudelDistortShapeEditorComp(ctx: Ctx<Props>) :
    Component<SprudelDistortShapeEditorComp.Props>(ctx) {
