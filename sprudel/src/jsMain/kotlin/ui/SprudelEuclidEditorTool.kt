...
private fun Tag.SprudelEuclidEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelEuclidEditorComp.Props(toolCtx, embedded)) { SprudelEuclidEditorComp(it) }

// ── Component ─────────────────────────────────────────────────────────────────

private class SprudelEuclidEditorComp(ctx: Ctx<Props>) : Component<SprudelEuclidEditorComp.Props>(ctx) {
