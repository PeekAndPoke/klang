...
object SprudelCompressorEditorTool : KlangUiToolEmbeddable {
    ...
    override fun FlowContent.render(ctx: KlangUiToolContext) {
        SprudelCompressorEditorComp(ctx, embedded = false)
    }

    override fun FlowContent.renderEmbedded(ctx: KlangUiToolContext) {
        SprudelCompressorEditorComp(ctx, embedded = true)
    }
}
...
private fun Tag.SprudelCompressorEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelCompressorEditorComp.Props(toolCtx, embedded)) { SprudelCompressorEditorComp(it) }
...
private class SprudelCompressorEditorComp(ctx: Ctx<Props>) : Component<SprudelCompressorEditorComp.Props>(ctx) {
