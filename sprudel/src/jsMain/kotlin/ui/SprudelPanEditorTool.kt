...
private fun Tag.SprudelPanEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelPanEditorComp.Props(toolCtx, embedded)) { SprudelPanEditorComp(it) }

// ── Component ─────────────────────────────────────────────────────────────────

private class SprudelPanEditorComp(ctx: Ctx<Props>) : Component<SprudelPanEditorComp.Props>(ctx) {
