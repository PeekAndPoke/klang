...
private fun Tag.SprudelWaveformEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelWaveformEditorComp.Props(toolCtx, embedded)) { SprudelWaveformEditorComp(it) }

// ── Component ─────────────────────────────────────────────────────────────────

private class SprudelWaveformEditorComp(ctx: Ctx<Props>) : Component<SprudelWaveformEditorComp.Props>(ctx) {
