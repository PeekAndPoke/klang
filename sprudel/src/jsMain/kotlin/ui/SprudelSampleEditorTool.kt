...
private fun Tag.SprudelSampleEditorComp(toolCtx: KlangUiToolContext, embedded: Boolean) =
    comp(SprudelSampleEditorComp.Props(toolCtx, embedded)) { SprudelSampleEditorComp(it) }

// ── Component ─────────────────────────────────────────────────────────────────

private class SprudelSampleEditorComp(ctx: Ctx<Props>) : Component<SprudelSampleEditorComp.Props>(ctx) {
