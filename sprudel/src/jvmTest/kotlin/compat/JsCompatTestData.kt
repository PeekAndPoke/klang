...
object JsCompatTestData {
    ...
    val patterns: List<Example> = listOf(
        ...
        Example(SKIP, "chunk 4 with 2 slices fast", """s("bd hh sd oh").chunk(2, x => x.fast(2))"""),
        ...
        Example("chunkInto basic", """seq("0 1 2 3").chunkInto(4, x => x.add(10))"""),
        Example("chunkInto with sound", """s("bd sd").chunkInto(2, x => x.gain(0.8))"""),
        Example("chunkInto with transpose", """note("c4 d4 e4 f4").chunkInto(4, x => x.transpose(12))"""),
        Example("chunkinto lowercase", """note("c4 d4 e4 f4").chunkinto(4, x => x.transpose(12))"""),
        Example("chunkInto with alternation", """seq("<0 5> 1 2").chunkInto(3, x => x.add(10))"""),
        Example("chunkBackInto basic", """seq("0 1 2 3").chunkBackInto(4, x => x.add(10))"""),
        Example("chunkBackInto with sound", """s("bd sd").chunkBackInto(2, x => x.gain(0.8))"""),
        Example("chunkBackInto with transpose", """note("c4 d4 e4 f4").chunkBackInto(4, x => x.transpose(12))"""),
        Example("chunkbackinto lowercase", """note("c4 d4 e4 f4").chunkbackinto(4, x => x.transpose(12))"""),
        ...
        *(1..8).flatMap { pulses ->
        ...
        Example("Ribbon basic", """note("0 1 2 3").slow(4).ribbon(1, 2)"""),
        Example("Ribbon single cycle", """note("a b").slow(2).ribbon(1, 1)"""),
        Example("Ribbon fractional", """note("a b").ribbon(0.5, 0.5)"""),
        Example("Ribbon with sound", """s("bd sd ht lt").slow(4).ribbon(2, 1)"""),
        Example("Ribbon offset 0", """note("c d e f").slow(4).ribbon(0, 2)"""),
        ...
        *listOf(
        ...
        //       ERROR: Native type 'SprudelPatternEvent' has no method 'data'.
