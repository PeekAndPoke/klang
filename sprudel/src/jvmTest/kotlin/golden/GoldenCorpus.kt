...
stack(
  ...
  n(`<[-7 0 2 4] [-7 0 4 [2 6]|[4 2]|2|2|2|2] [-5 -1 2 4] [-6 -1 [4 3]|5|3|3|3 [1 -1]|1|1|1|1]>*2`)
    .orbit(1).scale("<e4:minor!48 e5:minor!16>").sound("superramp").unison(11).spread(0.03).analog(feel)
  ...
  n(`<[7 4 2 <-1 4 1 3> [0 -1 -3 -1] [0 -3] -2 <[-1 4@3] [5 6@3] [4 7@3] [4 6@3]>]!4
    ...
    .sound("supersaw").unison(17).spread(0.08)
    ...
    .gain(0.6).postgain(0.365).hpf("<400!48 700!16 400!32 300!32>").lpq(1.5).lpf(saw.range(1,0).pow(1.5).mul(1000).add(1200).slow(4)).lpe(12).lpq(2.0)
  ...
  n("<0 0 2 4 0 0 -2 -1>")
    ...
    .analog(feel).sound("supersaw").unison(11).spread(0.08)
  ...
  n("<0 0 2 4 0 0 -2 -1>").struct("<[x!1]!32 [x@3 x]!32 [x!4]!64>").fast(2).velocity("1.00 0.95!3 0.98 0.95!3".fast(2))
    ...
    .adsr(0.015, 0.3, 0.0, 0.15).hpf(80).hpq(1).lpf(100).lpe(19).lpadsr(0.01, 0.1, 0.0, 0.22)
    .mute("<0!128 1!32>")
  , // Drums
