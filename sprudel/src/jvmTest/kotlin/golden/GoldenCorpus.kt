...
stack(
  ...
  sound("<[~!2]!2  [~!4]!2  [~!8]!2  [~!16]  [~!24]  [~  sd ~  sd]!24 [~  sd ~  sd]!24>").mute("<0!128 1!32>")
    .early(0.002).orbit(5).gain(0.95).hpf(180).lpf(7000).adsr(0.006, 0.25, 0.1, 0.1).superimpose(bpf(220).bpf(q = 4).gain(0.4)),
  sound("<[hh hh oh hh]!48 [cr hh cr hh]!16 [0 hh 0 hh]!16>").fast(2).mute("<0!128 1!32>")
    .late(0.004).orbit(5).gain(1.00).hpf(3000).lpf(freq = 6000, q = 1.2).adsr(0.01, 0.2, 0.5, 0.2)
