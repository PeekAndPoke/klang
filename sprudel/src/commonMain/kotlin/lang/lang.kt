 ...
 * to its own field (see `_mapNumericField`); `docs/tasks-archive/2026-09/20260907-sprudel-field-accessors.md`.
 */
 ...
 * setter can consume it (`pan(gain)`, `hpf(lpf.freq.mul(2))`). Each accessor object adds the setter as
 * its `invoke` member, so `gain(0.5)` stays the setter. See `docs/tasks-archive/2026-09/20260907-sprudel-field-accessors.md`.
 */
