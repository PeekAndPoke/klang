...
(supersine), drawTries 5/16/40, poolSize 256 (cap 1024), refreshEvery 10, selection "normal[:width[:blend]]" (default: median-centered serving over the pool vocabulary; width 0 = always the median take, 0.1 tight, 0.5 default; blend 0..1 = fraction of uniform VOCABULARY picks — still band-accepted takes; "normal::0.9" = almost random with a slight center edge; "random"; "roundrobin" opt-in — cycling can gargle), warmup 16 (eagerly seeded entries; 0 = fully lazy).
