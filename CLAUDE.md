...
| Door shape: musical inputs on the door (`wet` always first), secondary knobs on a builder behind a `configure` lambda that is last and always optional, dynamics stages flat, one shape per concept across the DSLs. | 2026-09-05, refined 2026-09-23 | `/dsl-design` §2, `docs/tasks/builtin-instruments.md` §3b |
