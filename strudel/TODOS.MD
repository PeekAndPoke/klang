...
- **Conditional & Probabilistic**: ~6 missing (4 completed: `degradeBy`, `degrade`, `undegradeBy`, `undegrade`)
...
### Total Estimated: ~140 features remaining

### Completed So Far: ~106 features! 🎉
