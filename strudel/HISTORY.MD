...
- 161+ DSL functions/methods (including arithmetic, bitwise, comparison, and logical operators)
- 16 core pattern types (including EuclideanPattern with legato support, ChoicePattern with selector/weights support,
  SometimesPattern,
