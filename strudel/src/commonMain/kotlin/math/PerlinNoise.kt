...
object PerlinNoise {
    ...
    private fun grad(hash: Int, x: Double): Double = if (hash and 1 == 0) x else -x
    ...
    fun noise(x: Double): Double {
        ...
        val res = lerp(u, grad(a, xf), grad(b, xf - 1))
        // Scale to roughly -1..1 range (Perlin 1D gradient is small)
        return res * 2.0
    }
}
