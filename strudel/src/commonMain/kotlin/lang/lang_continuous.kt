...
@StrudelDsl
val time by dslObject { ContinuousPattern { t -> t } }

/** Sine oscillator: 0 to 1, period of 1 cycle */
@StrudelDsl
val sine by dslObject { ContinuousPattern { t -> (sin(t * 2.0 * PI) + 1.0) / 2.0 } }
...
@StrudelDsl
val cosine by dslObject { ContinuousPattern { t -> (sin(t * 2.0 * PI + PI / 2.0) + 1.0) / 2.0 } }
...
@StrudelDsl
val saw by dslObject { ContinuousPattern { t -> t % 1.0 } }
...
@StrudelDsl
val isaw by dslObject { ContinuousPattern { t -> 1.0 - (t % 1.0) } }
...
@StrudelDsl
val square by dslObject { ContinuousPattern { t -> if (t % 1.0 < 0.5) 0.0 else 1.0 } }
...
/** Square oscillator: 0 or 1, period of 1 cycle */
@StrudelDsl
val perlin by dslObject { ContinuousPattern { t -> (PerlinNoise.noise(t) + 1.0) / 2.0 } }
