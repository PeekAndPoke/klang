...
fun SignalGen.lowpass(cutoffHz: Double, q: Double = 0.707, env: FilterEnvelope = FilterEnvelope.NONE): SignalGen =
    svf(SvfMode.LOWPASS, cutoffHz, q, env)

fun SignalGen.highpass(cutoffHz: Double, q: Double = 0.707, env: FilterEnvelope = FilterEnvelope.NONE): SignalGen =
    svf(SvfMode.HIGHPASS, cutoffHz, q, env)

fun SignalGen.bandpass(cutoffHz: Double, q: Double = 1.0, env: FilterEnvelope = FilterEnvelope.NONE): SignalGen =
    svf(SvfMode.BANDPASS, cutoffHz, q, env)

fun SignalGen.notch(cutoffHz: Double, q: Double = 1.0, env: FilterEnvelope = FilterEnvelope.NONE): SignalGen =
...
fun SignalGen.onePoleLowpass(cutoffHz: Double): SignalGen {
    var y = 0.0
    var alpha = 0.0
    var initialized = false
...
fun SignalGen.onePoleHighpass(cutoffHz: Double): SignalGen {
    var y = 0.0
    var xPrev = 0.0
    var a = 0.0
    var initialized = false
 ...
 */
fun SignalGen.formant(bands: List<FormantBand>): SignalGen {
