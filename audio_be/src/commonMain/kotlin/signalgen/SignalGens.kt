...
object SignalGens {
    ...
    fun sine(gain: Double = 1.0, analog: Double = 0.0): SignalGen {
        var phase = 0.0
    ...
    fun sawtooth(gain: Double = 0.6, analog: Double = 0.0): SignalGen {
    ...
    fun ramp(gain: Double = 0.6, analog: Double = 0.0): SignalGen {
        var phase = 0.0 // Normalized 0..1
        val drift = AnalogDrift(analog)
    ...
    fun square(gain: Double = 0.5, analog: Double = 0.0): SignalGen {
        var phase = 0.0 // Normalized 0..1
        val drift = AnalogDrift(analog)
    ...
    fun triangle(gain: Double = 0.7, analog: Double = 0.0): SignalGen {
        var phase = 0.0 // Normalized 0..1
        val drift = AnalogDrift(analog)
    ...
    fun zawtooth(gain: Double = 1.0, analog: Double = 0.0): SignalGen {
        var phase = 0.0 // Normalized 0..1
        val drift = AnalogDrift(analog)
    ...
    fun pulze(duty: Double = 0.5, gain: Double = 1.0, analog: Double = 0.0): SignalGen {
        var phase = 0.0 // Normalized 0..1
     ...
     */
    fun superSaw(voices: Int = 5, freqSpread: Double = 0.2, gain: Double = 0.6, analog: Double = 0.0, rng: Random = Random): SignalGen {
     ...
     */
    fun superSine(voices: Int = 5, freqSpread: Double = 0.2, gain: Double = 1.0, analog: Double = 0.0, rng: Random = Random): SignalGen {
        val v = voices.coerceIn(1, 32)
     ...
     */
    fun superSquare(voices: Int = 5, freqSpread: Double = 0.2, gain: Double = 0.5, analog: Double = 0.0, rng: Random = Random): SignalGen {
        val v = voices.coerceIn(1, 32)
        val phases = DoubleArray(v) { rng.nextDouble() }
        val voiceGain = gain / v.toDouble()
        val drift = AnalogDrift(analog)
     ...
     */
    fun superTri(voices: Int = 5, freqSpread: Double = 0.2, gain: Double = 0.7, analog: Double = 0.0, rng: Random = Random): SignalGen {
        val v = voices.coerceIn(1, 32)
        val phases = DoubleArray(v) { rng.nextDouble() }
        val voiceGain = gain / v.toDouble()
        val drift = AnalogDrift(analog)
     ...
     */
    fun superRamp(voices: Int = 5, freqSpread: Double = 0.2, gain: Double = 0.6, analog: Double = 0.0, rng: Random = Random): SignalGen {
        val v = voices.coerceIn(1, 32)
        val phases = DoubleArray(v) { rng.nextDouble() }
        val voiceGain = gain / v.toDouble()
        val drift = AnalogDrift(analog)
