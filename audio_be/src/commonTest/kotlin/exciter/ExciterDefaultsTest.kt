 ...
 *
 * These tests must pass both BEFORE and AFTER the refactoring of ExciterDsl defaults
 * from Param to Constant. They verify the contract between sprudel's oscParam() and
 * the registered oscillator definitions.
 */
class ExciterDefaultsTest : StringSpec({

    val sampleRate = 44100
    val blockFrames = 4410

    val registry = ExciterRegistry().apply { registerDefaults() }
