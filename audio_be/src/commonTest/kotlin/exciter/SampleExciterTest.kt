...
class SampleExciterTest : StringSpec({

    val sampleRate = 44100
    val blockFrames = 128

    fun createCtx(blockFrames: Int = 128) = ExciteContext(
    ...
    "freqHz is ignored" {
        ...
        val gen1 = SampleExciter(pcm, 1.0, 0.0, -1.0, -1.0, false, Double.MAX_VALUE)
        val gen2 = SampleExciter(pcm, 1.0, 0.0, -1.0, -1.0, false, Double.MAX_VALUE)
