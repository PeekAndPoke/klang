...
class SampleSignalGenTest : StringSpec({

    val sampleRate = 44100
    val blockFrames = 128

    fun createCtx(blockFrames: Int = 128) = SignalContext(
    ...
    "freqHz is ignored" {
        ...
        val gen1 = SampleSignalGen(pcm, 1.0, 0.0, -1.0, -1.0, false, Double.MAX_VALUE)
        val gen2 = SampleSignalGen(pcm, 1.0, 0.0, -1.0, -1.0, false, Double.MAX_VALUE)
